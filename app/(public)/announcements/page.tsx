  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-1">Stay updated with the latest from our providers</p>
      </div>
      ...
      {posts.length === 0 ? (
        <div className="text-center py-16">
          ...
          <p className="text-muted-foreground mt-1">Check back later for updates from our providers</p>
        </div>
      ) : (
