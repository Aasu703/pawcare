  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1">Chat with pet owners</p>
      </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-gray-500 truncate">{contact.subtitle || "User"}</p>
                      </div>
                    </button>
                  );
                })}
            ...
            {!active ? (
              ...
              <>
                <div className="px-4 py-3 border-b border-gray-200">
                  ...
                  <p className="text-xs text-gray-500">{active.subtitle || "User"}</p>
                </div>
